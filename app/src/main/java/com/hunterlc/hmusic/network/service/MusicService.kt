...
interface MusicService {
    //通过具体的歌单id获取里面包含的歌曲
    @GET("/playlist/detail")
    fun getMusicsByPlaylistId(@Query("id") id: Long, @Query("cookie") cookie: String): Call<DetailPlaylistData>
    ...
    @GET("/song/url")
    fun getSongUrlById(@Query("id") id: String, @Query("cookie") cookie: String): Call<SongUrl>
