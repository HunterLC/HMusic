...
import com.hunterlc.hmusic.data.SearchHotDetailData
import com.hunterlc.hmusic.data.SearchHotDetailInfo

class SearchHotAdapter(private val searchHotData: SearchHotDetailInfo): RecyclerView.Adapter<SearchHotAdapter.ViewHolder>(),
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        LayoutInflater.from(parent.context).inflate(R.layout.layout_search_hot, parent, false).apply {
