...
//        objectAnimator2.start()
    ...
    fun moveToRight(view: View) {
        val objectAnimator: ObjectAnimator = ObjectAnimator.ofFloat(view, "translationX", 0f, dp2px(300f).toFloat())
        objectAnimator.interpolator = DecelerateInterpolator()
    ...
    fun moveToLeft(view: View) {
        val objectAnimator: ObjectAnimator = ObjectAnimator.ofFloat(view, "translationX", dp2px(300f).toFloat(), 0f)
        objectAnimator.interpolator = LinearInterpolator()
        objectAnimator.duration = 250
        objectAnimator.start()
    }
